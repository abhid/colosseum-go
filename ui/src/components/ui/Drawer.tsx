...
export function Drawer({
  ...
  return (
    <div
      aria-hidden={!open}
      className={clsx(
        'fixed inset-0 z-50 flex justify-end transition-[background-color] duration-200',
    ...
    >
      <div
        ...
        tabIndex={-1}
        className={clsx(
          'flex h-full w-full flex-col overflow-hidden bg-white shadow-xl outline-none transition-transform duration-200 ease-out',
          widthClass,
      ...
      >
        <div className="flex items-start justify-between border-b border-gray-200 px-4 py-3">
          <div className="min-w-0">
            ...
            <div id={labelledById} className="truncate text-sm font-semibold text-gray-900">
              {title}
            </div>
          </div>
          <button
